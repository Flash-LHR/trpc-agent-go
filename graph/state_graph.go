...
func (r *llmRunner) executeModel(
	...
	if invocation != nil {
		if opts := graphCallOptionsFromConfigs(invocation.RunOptions.CustomAgentConfigs); opts != nil {
...
func processModelResponse(ctx context.Context, config modelResponseConfig) (context.Context, *event.Event, error) {
	...
	if ok && invocation != nil && jsonrepair.IsToolCallArgumentsJSONRepairEnabled(invocation) {
