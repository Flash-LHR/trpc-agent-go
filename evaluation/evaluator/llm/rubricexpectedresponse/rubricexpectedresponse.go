...
// Package rubricexpectedresponse evaluates agent outputs against teacher references using rubric-based LLM judges.
...
type rubricExpectedResponseEvaluator struct {
...
// New builds the expected-aware rubric response evaluator.
func New(opt ...Option) evaluator.Evaluator {
	opts := newOptions(opt...)
	e := &rubricExpectedResponseEvaluator{
...
func (e *rubricExpectedResponseEvaluator) Name() string {
	return "llm_rubric_expected_response"
}

// Description returns the description of the evaluator.
func (e *rubricExpectedResponseEvaluator) Description() string {
	return "LLM rubric response evaluator against expected references"
}

// Evaluate evaluates the response of the agent against expected references.
func (e *rubricExpectedResponseEvaluator) Evaluate(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricExpectedResponseEvaluator) ConstructMessages(ctx context.Context, actuals, expecteds []*evalset.Invocation,
...
func (e *rubricExpectedResponseEvaluator) ScoreBasedOnResponse(ctx context.Context, response *model.Response,
...
func (e *rubricExpectedResponseEvaluator) AggregateSamples(ctx context.Context, samples []*evaluator.PerInvocationResult,
...
func (e *rubricExpectedResponseEvaluator) AggregateInvocations(ctx context.Context, results []*evaluator.PerInvocationResult,
	evalMetric *metric.EvalMetric) (*evaluator.EvaluateResult, error) {
