...
import (
	...
	rmessagesconstructor "trpc.group/trpc-go/trpc-agent-go/evaluation/evaluator/llm/operator/messagesconstructor/rubricexpectedresponse"
...
// Option customizes RubricExpectedResponse evaluator dependencies.
type Option func(*options)

// WithMessagesConstructor sets the prompt builder for expected-aware rubric responses.
